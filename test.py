...
def test_model(cfg,
    ...
    colors_rgb = get_rgb_colors(num_classes, mean=cfg.INPUT.PIXEL_MEAN, scale=cfg.INPUT.PIXEL_SCALE)
    ...
    for src_file in tqdm(src_files):
        ...
        with torch.no_grad():
            for tile in tiles:
                # prepare input
                tile = (tile - cfg.INPUT.PIXEL_MEAN) / cfg.INPUT.PIXEL_SCALE
                ...
                result = result * cfg.INPUT.PIXEL_SCALE + cfg.INPUT.PIXEL_MEAN
